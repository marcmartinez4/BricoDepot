      ...
      <div class="d-flex justify-content-center fondo-menu-navegacion">
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-12 menu-navegacion">
                <a class="boton-menu-navegacion" href="<?= url ?>?controller=home">Home</a>
                <a class="boton-menu-navegacion" href="<?= url ?>?controller=pedido">Carta</a>
            </div>
        </div> 
    </div>
